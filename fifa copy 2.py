...
st.set_page_config(page_title="FIFA Records", page_icon=":bar_chart:", layout="wide")
...
def wholeApp():
    ...
    fc, sc, tc, foc, fic = st.columns([0.5, 0.5, 0.5, 0.2, 0.2])
    with fc:
